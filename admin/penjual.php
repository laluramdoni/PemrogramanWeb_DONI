					...
					<div class="col-md-12 fh5co-heading animate-box">
						...
						<table class="table table-responsive">
							...
							<tbody>
								...
								<?php
								// Query to retrieve Penjual details
								...
								if (mysqli_num_rows($result) > 0) {
									while ($row = mysqli_fetch_assoc($result)) {
										echo '<tr>
												...
												<td>' . $row['name'] . '</td>
												<td>' . $row['email'] . '</td>
												<td>	<a href="edit.php?id=' . $row['id'] . '" class="btn btn-primary btn-outline">Edit</a>
												<a href="delete.php?id=' . $row['id'] . '" class="btn btn-primary btn-outline">Delete</a></td>
										</tr>';
									}
								} else {
