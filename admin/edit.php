			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 fh5co-heading animate-box">
						<h2>Edit Penjual <?php echo $row['name']; ?></h2>

					</div>

					<div class="col-md-6 col-md-push-6 col-sm-6 col-sm-push-6">
						<form action="editPost.php" method="post" id="form-wrap">

							<div class="row form-group">
								<div class="col-md-12">
									<label for="nama_konser">Nama</label>
									<input type="text" name="name" id="nama_konser" value="<?php echo $row['name'] ?? ''; ?>" class="form-control" placeholder="Masukan Nama ..." required>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="email" name="email" id="kuota" class="form-control" value="<?php echo $row['email'] ?? ''; ?>" placeholder="Masukan Email ..." required>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" name="password" id="harga" class="form-control" placeholder="Masukan Password" >
								</div>
							</div>
							<input type="hidden" name="id" value="<?php echo $row['id'] ?? ''; ?>">
							<div class="form-group">
								<input type="submit" value="Update Penjual" class="btn btn-primary">
							</div>
