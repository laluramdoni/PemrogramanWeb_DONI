			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 col-md-push-6 col-sm-6 col-sm-push-6">
						...
						<form action="addPost.php" method="post" id="form-wrap" enctype="multipart/form-data">
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" name="nama_konser" id="nama_konser" class="form-control" placeholder="Concert Name" required>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="number" name="kuota" id="kuota" class="form-control" placeholder="Quota" required>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<textarea name="keterangan" id="keterangan" cols="30" rows="10" class="form-control" placeholder="Concert Detail" required></textarea>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="number" name="harga" id="harga" class="form-control" placeholder="Ticket Price" required>
								</div>
							</div>
